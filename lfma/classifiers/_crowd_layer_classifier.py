...
from ..modules import CrowdLayerModule, MultiAnnotatorDataSet


class CrowdLayerClassifier(LightningClassifier):
    ...
    def fit(
        ...
        self: CrowdLayerClassifier,
            `CrowdLayerClassifier` object fitted on the training data.
        """
        ...
        # Create CrowdLayer neural network.
        self.module_ = CrowdLayerModule(**self.module_dict_)

        # Train CrowdLayer neural network.
