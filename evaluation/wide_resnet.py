"""
Coda has been taken from the GitHub repository

https://github.com/meliketoy/wide-resnet.pytorch/blob/master/networks/wide_resnet.py under

the MIT License with Copyright (c) 2018 Bumsoo Kim.
"""
